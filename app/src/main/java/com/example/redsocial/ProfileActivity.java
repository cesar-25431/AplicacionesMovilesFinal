        ...
        call.enqueue(new Callback<Usuario>() {
            ...
            public void onResponse(Call<Usuario> call, Response<Usuario> response) {
                if (response.isSuccessful()) {
                    ...
                    Picasso.get().load("https://5283-179-6-55-223.ngrok-free.app/api/files/users_red_social/"+usuario.id+"/"+usuario.avatar).into(ic_publicacion_usuario);
        ...
        call.enqueue(new Callback<Usuario>() {
            ...
            public void onResponse(Call<Usuario> call, Response<Usuario> response) {
                if (response.isSuccessful()) {
                    ...
                    usuario = response.body();
                    Picasso.get().load("https://5283-179-6-55-223.ngrok-free.app/api/files/users_red_social/"+usuario.id+"/"+response.body().avatar).into(ic_publicacion_usuario);
                    tv_user_name.setText(usuario.username);
