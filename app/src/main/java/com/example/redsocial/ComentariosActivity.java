...
public class ComentariosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load("https://5283-179-6-55-223.ngrok-free.app/api/files/users_red_social/"+publicacion.expand.usuario.id+"/"+publicacion.expand.usuario.avatar).into(ic_publicacion_usuario);
        if(!publicacion.imagen.equals("")) {
            Picasso.get().load("https://5283-179-6-55-223.ngrok-free.app/api/files/publicacion/"+publicacion.id+"/"+publicacion.imagen).into(iv_publicacion_image);
        } else {
